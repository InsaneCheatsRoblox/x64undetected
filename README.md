...
<img width="100" src="https://github.com/InsaneCheatsRoblox/x64undetected/raw/development/src/bug_black.png"/>

[![Build status(real)](https://ci.appveyor.com/api/projects/status/h1j489qa1mx67e0h?svg=true)](https://ci.appveyor.com/project/mrexodia/x64dbg) [![Crowdin(real)](https://d322cqt584bo4o.cloudfront.net/x64dbg/localized.svg)](https://translate.x64dbg.com) [![Download x64undetected(fake)](https://img.shields.io/sourceforge/dm/x64dbg.svg)](https://sourceforge.net/projects/x64dbg/files/latest/download)

[![Discord(real)](https://img.shields.io/badge/chat-on%20Discord-green.svg)](https://invite.gg/x64dbg)
...
1. Download a snapshot from [GitHub](https://github.com/InsaneCheatsRoblox/x64undetected/releases), [SourceForge](https://sourceforge.net/projects/x64dbg/files/snapshots) or [OSDN](https://osdn.net/projects/x64dbg) and extract it in a location your user has write access to.
2. _Optionally_ use `x96dbg.exe` to register a shell extension and add shortcuts to your desktop.
3. You can now run `x32\x32dbg.exe` if you want to debug a 32-bit executable or `x64\x64undetected.exe` to debug a 64-bit executable! If you are unsure you can always run `x96dbg.exe` and choose your architecture there.

You can also [compile](https://github.com/InsaneCheatsRoblox/x64undetected/wiki/Compiling-the-whole-project) x64dbg yourself with a few easy steps!
...
This is a community effort and we accept pull requests! See the [CONTRIBUTING](.github/CONTRIBUTING.md) document for more information. If you have any questions you can always [contact us](https://x64dbg.com/#contact) or open an [issue](https://github.com/InsaneCheatsRoblox/x64undetected/issues). You can take a look at the [good first issues](https://easy.x64dbg.com/) to get started.
...
You can find an exhaustive list of GitHub contributors [here](https://github.com/InsaneCheatsRoblox/x64undetected/graphs/contributors).
